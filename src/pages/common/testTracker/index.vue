    ...
    <div class="bottom-box container">
      ...
      >
        ...
        <swiper-item class="control-swiper-item">
          ...
          <div class="set-box">
            <img src="https://staging-tsp-1308146855.cos.ap-shanghai.myqcloud.com/20221230/web/1672370835156-427-setBox.png">
            <div class="flex set-icon">
              <div class="text-center">
                <p class="text-sm ml-3 mb-mini">
                  主驾加热
                </p>
                <img class="set-img" src="https://staging-tsp-1308146855.cos.ap-shanghai.myqcloud.com/20221230/web/1672370875096-259-setImg.png">
              </div>
              <div class="text-center">
                <p class="text-sm ml-3 mb-mini">
                  副驾加热
